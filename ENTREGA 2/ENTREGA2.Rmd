...
```
Podemos observar que la varianza de la media muestral que hemos obtenido, es muy parecida a la teórica, sobreestimando el valor teórico en tan solo un 9%. Si el tamaño muestral aumentará infinitamente, la varianza muestral convergería a la poblacional. 
